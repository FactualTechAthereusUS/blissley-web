...
type ReviewItem = { type: "photo"; src: string } | { type: "review"; data: typeof reviews[0] };

const row1: ReviewItem[] = [
...
function MarqueeRow({ items, speed }: { items: ReviewItem[]; speed: number }) {
...
export default function LP3Reviews() {
  return (
    <section className="bg-white py-14 sm:py-20 overflow-hidden" id="reviews">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 text-center">
        ...
        <FadeUp delay={0.16}>
          <p className="text-sm text-gray-500 max-w-md mx-auto leading-relaxed" style={{ fontFamily: "var(--font-manrope)" }}>
            Not models. Not actors. Not AI-generated images.
          </p>
        </FadeUp>
      </div>
